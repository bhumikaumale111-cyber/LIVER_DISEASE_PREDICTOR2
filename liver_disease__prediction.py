...
Logistic Regression’s training accuracy (96%) and test accuracy (91%) are close, which means it generalizes very well.

— Simplicity & Interpretability:
It’s also easier to interpret — each feature’s coefficient shows its impact on the disease prediction.
